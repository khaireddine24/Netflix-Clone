          ...
          <div className="absolute bottom-0 w-full">
            <div>
              ...
              <div className="flex gap-4 max-sm:my-4 my-10">
                <button onClick={()=>navigate(`/Netflix-Clone/movie/${selectedMovie?.id}`)} className="bg-white text-black px-5 py-2 transition-colors hover:bg-[#ffffffbf] rounded flex items-center gap-3 text-base">
                  <FaPlay />
                  <span>Play</span>
                </button>
